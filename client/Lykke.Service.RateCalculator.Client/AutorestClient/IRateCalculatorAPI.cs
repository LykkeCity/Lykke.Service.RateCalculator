...
namespace Lykke.Service.RateCalculator.Client.AutorestClient
{
    ...
    public partial interface IRateCalculatorAPI : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<IList<AssetConversionRate>>> ApiRateCalculatorGetConversionRatesForAssetsByBaseAssetIdPostWithHttpMessagesAsync(string baseAssetId, IList<AssetRequest> assetIds = default(IList<AssetRequest>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
